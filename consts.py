"""
Constants for frogger

This module contains global constants for the game frogger.
...
everything after the word python. So if you start the game typing
    ...
    python frogger default.json 1

Python puts ['frogger', 'default.json', '1'] into sys.argv. Below, we take advantage of
